...
public class Register extends AppCompatActivity {
    ...
    class DownloadData extends AsyncTask<String, Void, Integer> {
        ...
        protected Integer doInBackground(String... strings) {
            ...
            int parsingFeedback = feedback.SUCCESS;

            SharedPreferences userslist;
            userslist = getSharedPreferences("Users",0);
            SharedPreferences.Editor editor=userslist.edit();
